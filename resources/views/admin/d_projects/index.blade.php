            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <a href="{{ route('admin.d_projects.create') }}" class="btn btn-primary">create</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                            ...
                            @foreach ($d_projects as $project)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $text = $project->hitchen;
                                            $chunks = str_split($text, 30);
                                            echo implode('<br>', $chunks);
                                        @endphp
                                    </td>
                                    <td>
                                        <img alt="image" src="/site/images/d_projects/{{$project->images}}" width="35">
                                    </td>
                                    <td style="d-flex">
                                        <a href="{{ route('admin.d_projects.destroy',$project->id) }}" class="btn btn-primary">Show</a>
                                        <a href="{{ route('admin.d_projects.edit',$project->id) }}" class="btn btn-success">Edit</a>
                                        <form style="display:inline" action="{{ route('admin.d_projects.destroy',$project->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
